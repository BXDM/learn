...
[参考链接](https://blog.csdn.net/code4101/article/details/41802715?utm_source=tuicool&utm_medium=referral#)

1.在word中新建一个**一行两列**的表格，第一列为行号，第二列为源代码。

2.按下Alt + F11，打开**模块**编辑窗口，粘贴入以下代码并保存。
...
3.选中第一列，按下Alt + F8，执行**输入连续数字**，再执行**设置代码表格**。